...
public:
    ...
    Setting<std::vector<StoreReference>> substituters{
        ...
        R"(
          ...
          A substituter is an additional [store](@docroot@/glossary.md#gloss-store) from which Nix can obtain [store objects](@docroot@/store/store-object/index.md) instead of building them.
