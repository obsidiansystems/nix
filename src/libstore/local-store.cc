    ...
    bool filterReferences)
{
    ...
    // TODO: don't pathSink when unneeded
    auto refSink = PathRefScanSink::fromPaths(originalReferences);
    TeeSink teeSink{*hashSink, refSink};
    TeeSource source{source0, teeSink};
