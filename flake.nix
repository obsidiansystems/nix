    ...
    in {
      ...
      devShells = let
        ...
        in forAllSystems(system:
          let
            makeShells = pkgs: forAllStdenvs (stdenvName:
               makeShell pkgs pkgs.${stdenvName});
          in {
            native = makeShells nixpkgsFor.${system}.native;
            static = makeShells nixpkgsFor.${system}.static;
            default = self.devShells.${system}.native.stdenv;
          } // (
          forAllCrossSystems (crossSystem:
            let
