...
(! nix path-info --store $TEST_ROOT/machine3 --all | grep builder-build-remote-input-1.sh)
...
(! nix path-info --store $TEST_ROOT/machine3 --all | grep builder-build-remote-input-2.sh)
