...
A `.narinfo` file contains the [metadata of a store object](@docroot@/store/store-object/index.md#metadata) in the [binary cache](@docroot@/protocols/binary-cache/index.md) format.
