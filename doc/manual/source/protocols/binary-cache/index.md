...
- For each [store object](@docroot@/store/store-object/index.md):
  - A [`.narinfo`](./narinfo.md) file containing the object's [metadata](@docroot@/store/store-object/index.md#metadata) and a (usually relative) URL to the corresponding compressed NAR.
